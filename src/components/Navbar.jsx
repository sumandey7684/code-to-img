...
const URL = "https://codetoimg-suman.vercel.app/";
  ...
  return (
    <div className="flex justify-center items-center">
      ...
      <div className="fixed flex flex-row justify-center items-center top-4 right-[1px] mr-3 lg:mr-0 cursor-pointer">
        <NavLink to="https://github.com/sumandey7684/code-to-image">
          <AiFillGithub
            className="cursor-pointer"
        ...
        <div className="hidden lg:flex">
          <a
            href="https://www.producthunt.com/posts/code-to-image?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-code&#0045;to&#0045;image"
            target="_blank"
          >
            <img
        ...
        <div className=" flex justify-center items-center mr-3">
          ...
          <div className="hidden sm:block">
            <a href="https://www.buymeacoffee.com/sumandey" target="_blank">
              <img
                className=""
          ...
          <div className="flex sm:hidden ml-[10px]">
            <a
              href="https://www.buymeacoffee.com/sumandey"
              className=""
              target="_blank"
            >
              <img
