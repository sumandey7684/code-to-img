      ...
      <div id="my-node" className={`outerCanvas`}>
        <div
          ...
          className={`${
            bgTheme === "solid"
              ? "canThemeSolid"
              : `${bgTheme === "linear" ? "canThemeLinear" : "canThemeRadial"}`
          }`}
        >
          <div
            className={`max-h-unset ${
              snippetMode === "dark" ? "codeBox" : "codeBox-light"
            } min-w-[70%] min-h-[70%]`}
          >
            <div className="flex flex-row max-h-unset relative top-0 w-[100%] min-h-[10px] rounded-[25px] bg-transparent z-0">
              <div className="flex flex-row max-h-unset relative top-0 h-[10%] rounded-[25px] bg-transparent z-0">
                <div
                  className={`relative mt-[13px] ml-[17px] w-[12px] h-[12px] rounded-full ${
                    snippetMode === "dark" ? "smallBtn" : "smallBtn-light"
                  }`}
                />
                <div
                  className={`relative mt-[13px] ml-[8px] w-[12px] h-[12px] rounded-full ${
                    snippetMode === "dark" ? "smallBtn" : "smallBtn-light"
                  }`}
                />
                <div
                ...
                <input
                  ...
                  className={` bg-transparent ${
                    snippetMode === "dark"
                      ? "text-[#efebebc7]"
                      : "text-[#565656c7]"
                  } text-[13px] text-center editable-title`}
                ></input>
              </div>
            </div>
                ...
                >
                  <Editor
                    ...
                    style={{
                      ...
                      fontSize: 16,
                      color: `${
                        snippetMode === "dark" ? "#6AE970" : "#046A08"
                      }`,
                      margin: "20px",
                      fontStyle: "normal",
                    }}
